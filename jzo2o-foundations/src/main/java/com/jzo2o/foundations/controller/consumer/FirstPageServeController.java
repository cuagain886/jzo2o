...
public class FirstPageServeController {
    ...
    @SentinelResource(
            value="home:firstPageServeList",
            blockHandlerClass = SentinelBlockHandlers.class,
            blockHandler = "handleServeCategoryBlock"
    )
    ...
    @SentinelResource(
            value = "home:hotServeList",
            blockHandlerClass = SentinelBlockHandlers.class,
            blockHandler = "handleHotServeBlock"
    )
    ...
    @SentinelResource(
            value = "home:serveTypeList",
            blockHandlerClass = SentinelBlockHandlers.class,
            blockHandler = "handleServeTypeBlock"
    )
    ...
    @SentinelResource(
            value = "search:serveList",
            blockHandlerClass = SentinelBlockHandlers.class,
            blockHandler = "handleServeSearchBlock"
    )
