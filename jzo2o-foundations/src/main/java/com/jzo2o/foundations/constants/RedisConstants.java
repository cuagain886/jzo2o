...
public class RedisConstants {
    ...
    public static final class LockName{
         ...
         * 热点服务详情缓存重建锁
         */
        public static final String HOT_SERVE_REBUILD_LOCK="JZ_LOCK:HOT_SERVE:";

        /**
         * 热点服务项详情缓存重建锁
         */
        public static final String HOT_SERVE_ITEM_REBUILD_LOCK="JZ_LOCK:HOT_SERVE_IETM:";

        /**
         * 活跃区域列表缓存重建锁
         */
        public static final String ACTIVE_REGION_REBUILD_LOCK="JZ_LOCK:ACTIVE_REGION:";
